    ...
    <form class="form form--add-lot container <?= !empty($errors) ? 'form--invalid' : '' ?>" action="add.php"
        ...
        <div class="form__container-two">
            <div class="form__item <?= isset($errors['lot-name']) ? 'form__item--invalid' : '' ?>">
                ...
                <input id="lot-name" type="text" name="lot-name" placeholder="Введите наименование лота"
                    value="<?= htmlspecialchars($postData['lot-name'] ?? ''); ?>">
            ...
            <div class="form__item <?= isset($errors['category']) ? 'form__item--invalid' : '' ?>">
                ...
                <select id="category" name="category">
                    ...
                    <?php foreach ($categories as $category): ?>
                        <option value="<?= htmlspecialchars($category['id']); ?>" <?= (($postData['category'] ?? '') === $category['id']) ? 'selected' : '' ?>>
        ...
        <div class="form__item form__item--wide <?= isset($errors['message']) ? 'form__item--invalid' : '' ?>">
            ...
            <textarea id="message" name="message"
                placeholder="Напишите описание лота"><?= htmlspecialchars($postData['message'] ?? ''); ?></textarea>
        ...
        <div class="form__container-three">
            ...
            <div class="form__item <?= isset($errors['lot-date']) ? 'form__item--invalid' : '' ?>">
                ...
                <input class="form__input-date" id="lot-date" type="text" name="lot-date"
                    ...
                    value="<?= htmlspecialchars($postData['lot-date'] ?? ''); ?>">
